...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /root/noor_robot_simulation/src/navigation)
  set(navigation_DEVEL_PREFIX /root/noor_robot_simulation/devel)
  ...
  set(navigation_INSTALL_PREFIX /root/noor_robot_simulation/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/noor_robot_simulation/src/navigation/${idir}'.  ${_report}")
    endif()
